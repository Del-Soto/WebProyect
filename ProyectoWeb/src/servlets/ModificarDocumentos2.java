...
@WebServlet("/actualizarDocumentos")

public class ModificarDocumentos2 extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	
	public ModificarDocumentos2() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		    throws ServletException, IOException
			{
				...
				else
				{
					...
					int resultado = documentosbs.actualizarDocumentos(documentos1);
